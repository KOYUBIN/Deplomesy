...
export const INITIAL_TERRITORIES: Territory[] = [
  { id: 0,  name: '브락시스',      x: 200, y: 80,  adjacentIds: [1, 3, 4],               minerals: 1, gasYield: 0, isStrategic: false, ownerId: null, units: [] },
  { id: 1,  name: '안티가 프라임', x: 500, y: 80,  adjacentIds: [0, 2, 4, 5],            minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
  { id: 2,  name: '타소니스',      x: 800, y: 80,  adjacentIds: [1, 5, 6],               minerals: 1, gasYield: 0, isStrategic: false, ownerId: null, units: [] },
  { id: 3,  name: '코랄',          x: 120, y: 210, adjacentIds: [0, 4, 7, 8],            minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
  { id: 4,  name: '카스타나르',    x: 380, y: 210, adjacentIds: [0, 1, 3, 5, 8, 9],     minerals: 1, gasYield: 0, isStrategic: true,  ownerId: null, units: [] },
  { id: 5,  name: '티라도르',      x: 620, y: 210, adjacentIds: [1, 2, 4, 6, 9, 10],    minerals: 1, gasYield: 0, isStrategic: true,  ownerId: null, units: [] },
  { id: 6,  name: '모리아',        x: 880, y: 210, adjacentIds: [2, 5, 10, 11],          minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
  { id: 7,  name: '마 사라',       x: 60,  y: 340, adjacentIds: [3, 8, 12, 13],          minerals: 1, gasYield: 0, isStrategic: false, ownerId: null, units: [] },
  { id: 8,  name: '마인호프',      x: 290, y: 340, adjacentIds: [3, 4, 7, 9, 12, 13],   minerals: 1, gasYield: 0, isStrategic: false, ownerId: null, units: [] },
  { id: 9,  name: '코어 월드',     x: 500, y: 340, adjacentIds: [4, 5, 8, 10, 13, 14],  minerals: 3, gasYield: 2, isStrategic: true,  ownerId: null, units: [] },
  { id: 10, name: '프라이드워터',  x: 710, y: 340, adjacentIds: [5, 6, 9, 11, 14, 15],  minerals: 1, gasYield: 0, isStrategic: false, ownerId: null, units: [] },
  { id: 11, name: '도미니온',      x: 940, y: 340, adjacentIds: [6, 10, 15],             minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
  { id: 12, name: '아이어',        x: 150, y: 470, adjacentIds: [7, 8, 13, 16],          minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
  { id: 13, name: '솔라리스',      x: 380, y: 470, adjacentIds: [7, 8, 9, 12, 14, 16, 17], minerals: 1, gasYield: 0, isStrategic: true, ownerId: null, units: [] },
  { id: 14, name: '우모자',        x: 620, y: 470, adjacentIds: [9, 10, 13, 15, 17, 18], minerals: 1, gasYield: 1, isStrategic: true, ownerId: null, units: [] },
  { id: 15, name: '샤쿠라스',      x: 850, y: 470, adjacentIds: [10, 11, 14, 18],        minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
  { id: 16, name: '칼디르',        x: 200, y: 600, adjacentIds: [12, 13, 17],            minerals: 1, gasYield: 0, isStrategic: false, ownerId: null, units: [] },
  { id: 17, name: '제루스',        x: 500, y: 600, adjacentIds: [13, 14, 16, 18],        minerals: 1, gasYield: 2, isStrategic: false, ownerId: null, units: [] },
  { id: 18, name: '차르',          x: 800, y: 600, adjacentIds: [14, 15, 17],            minerals: 2, gasYield: 1, isStrategic: false, ownerId: null, units: [] },
];
