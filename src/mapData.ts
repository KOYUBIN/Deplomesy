...
// SVG viewport: 1000 x 680
// 19 territories across 5 rows in a hexagonal-ish layout
export const INITIAL_TERRITORIES: Territory[] = [
  // Row 1 (top) — 3 territories
...
// Starting territory IDs for each player slot (up to 6)
export const PLAYER_STARTS = [3, 18, 12, 2, 0, 15];

export const WIN_THRESHOLD = 11; // out of 19 territories
